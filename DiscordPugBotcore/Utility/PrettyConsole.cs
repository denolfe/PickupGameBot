...
namespace DiscordPugBotcore.Utility
{
    public static class PrettyConsole
    {
        ...
        {
            PrettyConsole.NewLine($"{DateTime.Now:hh:mm:ss} ", ConsoleColor.DarkGray);
            PrettyConsole.Append($"[{severity,7}] ", ConsoleColor.Red);
            PrettyConsole.Append($"{source,10}: ", ConsoleColor.DarkGreen);
        ...
        public static void Log(IUserMessage msg)
        {
            ...
            PrettyConsole.NewLine($"{DateTime.Now:hh:mm:ss} ", ConsoleColor.Gray);
